...
export const Route = createFileRoute("/evaluation")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://expatboost.com/evaluation" },
    ...
    links: [{ rel: "canonical", href: "https://expatboost.com/evaluation" }],
  }),
            ...
            <form onSubmit={submit} className="space-y-6 rounded-2xl border border-border bg-card p-5 shadow-[var(--shadow-card)] sm:p-8">
              ...
              {step === 5 && (
                <div className="grid gap-5 sm:grid-cols-2">
                  ...
                  <Select label="Comment avez-vous connu Expat Boost ?" value={data.hearAbout} onChange={update("hearAbout")} options={["Recherche Google", "Réseaux sociaux", "Recommandation", "Article / blog", "Autre"]} />
                  ...
                  <label className="sm:col-span-2 flex items-start gap-3 rounded-lg border border-border bg-secondary/40 p-4 text-base">
                    ...
                    <span className="text-muted-foreground">
                      J'accepte que Expat Boost utilise les informations ci-dessus pour évaluer mon admissibilité et me répondre par email. Aucune donnée n'est partagée avec des tiers.
                    </span>
                  </label>
                </div>
              )}
