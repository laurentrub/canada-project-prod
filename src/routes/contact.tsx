...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Réservez votre consultation gratuite de 30 minutes avec un conseiller en immigration." },
      { property: "og:url", content: "https://expatboost.com/contact" },
    ...
    links: [{ rel: "canonical", href: "https://expatboost.com/contact" }],
  }),
  component: Contact,
});
