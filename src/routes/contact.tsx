    ...
    <div>
      ...
      <section className="mx-auto grid max-w-6xl gap-12 px-6 py-20 md:grid-cols-[1fr_1.4fr]">
        <div className="space-y-6">
          ...
          <div className="flex gap-4">
            <span className="grid h-10 w-10 flex-none place-items-center rounded-lg bg-primary/10 text-primary"><Phone className="h-4 w-4" /></span>
            <div>
              <p className="font-semibold">Téléphone</p>
              <p className="text-sm text-muted-foreground">+1 (514) 555-0182</p>
            </div>
          </div>
          <div className="flex gap-4">
            <span className="grid h-10 w-10 flex-none place-items-center rounded-lg bg-primary/10 text-primary"><MapPin className="h-4 w-4" /></span>
            <div>
              <p className="font-semibold">Bureau</p>
              <p className="text-sm text-muted-foreground">1250 boul. René-Lévesque<br />Montréal, QC, Canada</p>
            </div>
          </div>
        </div>
