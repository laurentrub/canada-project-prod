...
export const Route = createFileRoute("/programmes")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Explorez les principales voies d'immigration vers le Canada : Express Entry, PNP, études, travail, famille." },
      { property: "og:url", content: "https://expatboost.com/programmes" },
    ...
    links: [{ rel: "canonical", href: "https://expatboost.com/programmes" }],
  }),
