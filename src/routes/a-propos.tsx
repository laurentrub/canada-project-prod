...
export const Route = createFileRoute("/a-propos")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Une équipe de conseillers réglementés dédiée à votre projet d'immigration canadien." },
      { property: "og:url", content: "https://expatboost.com/a-propos" },
    ...
    links: [{ rel: "canonical", href: "https://expatboost.com/a-propos" }],
  }),
  component: APropos,
});
